                    ...
                    <div className="nine columns main-col">
                        ...
                        <div className="row item">
                            ...
                            <div className="twelve columns">
                                ...
                                <p className="info">Master in Graphic Design <span>&bull;</span> <em className="date">April
                                    2007</em></p>
                        ...
                        <div className="row item">
                            ...
                            <div className="twelve columns">
                                ...
                                <p className="info">B.A. Degree in Graphic Design <span>&bull;</span> <em
                                    className="date">March 2003</em></p>
                    ...
                    <div className="nine columns main-col">
                        ...
                        <div className="row item">
                            ...
                            <div className="twelve columns">
                                ...
                                <p className="info">Senior UX Designer <span>&bull;</span> <em className="date">March
                                    2010 - Present</em></p>
                        ...
                        <div className="row item">
                            ...
                            <div className="twelve columns">
                                ...
                                <p className="info">UX Designer <span>&bull;</span> <em className="date">March 2007 -
                                    February 2010</em></p>
